	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 d-flex justify-content-start">
				<div class="allGroup mb-1"
					style="font-size: 30px; font-family: katuri;">모임 전체</div>
			</div>
		</div>
		<div class="back row">
			<div class="col-md-4 button_base b05_3d_roll locationBtn"
				id="locationBtn">
				<div style="font-family: katuri;">지역</div>
				<div style="font-family: katuri;">지역</div>
			</div>
			<div class="col-md-4 button_base b05_3d_roll categoryBtn"
				id="categoryBtn">
				...
				<div class="imgContainer">
					<div class="row" style="padding: 18px;">
						<c:if test="${selectAllList.size() == 0}">
							<div
								class="col-sm-12 col-md-12 d-flex flex-column align-items-center justify-content-center">
								<div>
									<div>
										<h3>
									...
									<div style="font-size: 18px;">자신이 모임장이 되어서 취미를 공유하고 모임
										일정을 통해 즐거운 만남과, 모임 게시판, 모임 채팅을 활용하여 다양한 이야기와 취미활동을 공유하세요.</div>
						...
						<c:if test="${selectAllList.size() > 0}">
							<c:forEach items="${selectAllList}" var="dto">
								<div
									class="col-xl-3 col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center p-4">
									<div class="card">
										<c:choose>
										...
										<div class="card-body">
											...
											<div class="card-text-site d-flex justify-content-end">
												<span><i class="fa-solid fa-location-dot"
													style="color: #00145a"></i><span class="ms-2"
													style="color: #00145a; font-family: Katuri;">${dto.group_site}</span></span>
											</div>
										</div>
									</div>
								</div>
