		...
		<div class="container-btn">
			...
			<div class="row rowBtn">
				<div class="col-sm-3 btnBox">
					<div id="groupApply" class="btn-3d blue" style="font-weight: bold;">가입
						신청</div>
				</div>
				<div class="col-sm-3 btnBox">
				...
				<div class="col-sm-3 btnBox">
					<div id="groupDelete" class="btn-3d blue groupBtn"
	...
	<div class="container-content mt-5 py-5">
		<div class="row content-delete m-auto py-5">
			<div class="col-md-6">
				...
				<p class="text text-muted light-300"
					...
					모임 해산시 해당 정보는 되돌릴 수 없습니다.<br> <br> 1) 해당 모임의 활동 기록은
					사라집니다.<br> <br> 2) 모임에 속해있던 모임원들은 자동으로 모임에서 탈퇴됩니다.<br>
					<br> 3) 모임에서 작성한 게시글 및 일정은 더이상 볼 수 없습니다.<br> <br> 4)
					모임해산은 되돌릴 수 없습니다.
				</p>
			</div>
		...
		<div class="row">
			<div class="col-md-12 d-flex justify-content-center"
				...
				<div data-text="모임 해산하기" id="deleteBtn" class="deleteBtn"
					style="font-family: 'MICEGothic Bold';">모임 해산하기</div>
			</div>
		</div>
	</div>
	<!-- 그룹번호 숨겨서 받기 -->
