...
<body>
	...
	<div style="text-align: center;">
		<span class="modify-title">Modify Group</span><span><img
		...
		<form action="/group/modifyGroup" method="post"
			...
			<div class="row style mt-4">
				...
				<div
					...
					<span style="font-family: InfinitySans-RegularA1; font-size: 14px;">주제가
						...
						가능합니다.<br> <br> 기존에 선택하셨던 주제는 <strong
						style="color: red;">${tbl_group_dto.group_category}</strong> 입니다.
					</span>
					<div class="row mt-4">
						<div class="col-md">
							<button type="button"
			...
			<div class="row style mt-5">
				...
				<div
					...
					<strong style="font-family: InfinitySans-RegularA1;"mt-2">모임
						이름</strong> <span
						style="font-family: InfinitySans-RegularA1; font-size: 14px;"
					...
					<div class="mb-3 mt-2">
						<input type="text" class="form-control" id="group_title"
							...
							maxlength='24' value="${tbl_group_dto.group_title}">
			...
			<div class="row style mt-5">
				...
				<div
					...
					<span style="font-family: InfinitySans-RegularA1; font-size: 14px;">해당
						지역의 사람들이 귀하의 이벤트를 발견하도록 돕고 <br> 참석자들에게 위치를 제공해주세요.<br> <br>
						기존에 선택하셨던 위치는 <strong style="color: red;">${tbl_group_dto.group_site}</strong>
						입니다.
					</span> <span class="mt-2" style="font-family: InfinitySans-RegularA1;"><strong>새로운
							지역 설정</strong></span>
			...
			<div class="row style mt-5">
				...
				<div
					...
					<span style="font-family: InfinitySans-RegularA1; font-size: 14px;">썸네일로
			...
			<div class="row style mt-5">
				...
				<div
					...
					<span style="font-family: InfinitySans-RegularA1; font-size: 14px;">인원수를
						조정을 통해 유동적인 모임을 생성하세요!<br> 인원은 최소 2명부터 최대 10명까지 가능합니다.<br>
	...
	<div
		...
		<span class="mainFooterBtnBox">
			...
			<button class="btn btn-warning ms-4" id="modifyGroupBtn">동의
				후 수정</button>
		</span>
	</div>
