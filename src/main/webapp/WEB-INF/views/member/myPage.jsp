...
<body>
	...
	<div class="header">
		<div class="row mb-4 text-center justify-content-center">
			<div class="col-auto">
				<h1 style="font-family: 'Mochiy Pop One', sans-serif;">My
					Profile</h1>
				<div class="line"></div>
			</div>
		...
		<form action="/mem/modifyProfilePic" method="post" id="modifyPicForm"
			...
			<div class="row">
				<div class="col-md-8 modifyPro text-center" style="display: none;">
					<i class="fa-solid fa-folder-plus ms-5 me-3"></i> <span
						id="modifyProfilePic" style="cursor: pointer; user-select: none">프로필
						사진 변경</span>
				</div>
				...
				<div class="col-md-4 profileBtns justify-content-start"
					...
					<c:choose>
						<c:when test="${loginType eq 'general'}">
							<button type="button"
								class="btn btn-outline-primary profileBtn me-3"
					...
					<button type="button"
						class="btn btn-outline-danger profileBtn ms-3" id="profileDelete">회원탈퇴</button>
	...
	<div class="container" style="max-width: 1620px;">
		<div style="margin: auto;">
			<div class="row body" style="margin: 0px;">
				<div
					class="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center mt-5">
				...
				<div class="modal fade" id="exampleModal1" tabindex="-1"
					aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div
						class="modal-dialog modal-dialog-centered justify-content-center d-flex">
						<div class="modal-content" style="width: 350px;">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">선호지역(최대
									3개선택)</h5>
									...
									<div class="col" id="modal">
										<div class="row" style="height: 100%;">
											...
											<div class="col-3 hobbyWrapper">
												...
												<div>
													<input onclick="CountChecked(this)" type="checkbox"
														id="문화/공연/축제" name="hobby" class="checkbox me-1"
														value="문화/공연/축제"> <label for="문화/공연/축제">문화/공연/축제</label>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row description" style="color: #008A65;">
										...
										<div class="col-7 d-flex justify-content-start text-start">
											<span style="word-break: break-all;"> <a
												...
												style="padding: 0px;">${Groupdto.TITLE}</a>
											</span>
										</div>
										<div class="col-2"></div>
									</div>
								...
								<c:if test="${Groupdto.access eq '멤버'}">
									<div class="row description" style="color: #008A65;">
										...
										<div class="col-7 d-flex justify-content-start text-start">
											<span><a
												href="/group/toGroupDetail?seq_group=${Groupdto.SEQ_GROUP}"
												style="padding: 0px;">${Groupdto.TITLE}</a></span>
										</div>
										<div class="col-2"></div>
									</div>
								</c:if>
					...
					<div class="serviceBox color2 m-2">
						...
						<c:if test="${selectBoardList.size() > 0}">
							...
							<div class="myWrite mt-3">
								<span class="towritePage" id="towritePage"
									style="color: #27436d;">더보기 <i
							...
							<c:forEach items="${selectWishList}" var="wishlistdto" begin="0"
								...
								<div class="row description" id="wishBox"
									...
									<div class="col-6 d-flex justify-content-start text-start">
										<span style="word-break: break-all;"><a
											href="/group/toGroupDetail?seq_group=${wishlistdto.SEQ_GROUP}">${wishlistdto.TITLE}</a></span>
									</div>
				...
				<div class="modal fade" id="staticBackdrop"
					...
					<div
						class="modal-lg justify-content-center modal-dialog modal-dialog-scrollable modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-header"
								style="background-color: #FFFEE9; border-bottom: 2px solid #FFE19E;">
								...
								<button type="button" class="btn-close" data-bs-dismiss="modal"
									onclick="moveSite();" aria-label="Close"></button>
							</div>
							<!-- 답장 (보낸사람 클릭시 활성화 -->
							<div class="d-none" id="msgForm" style="padding: 14px;">
								<div class="row">
									<div class="col-md-12">
										...
										<input type="text" class="form-control mt-2" id="user_receive"
											readonly>
									</div>
								</div>
								<div class="row mt-2">
