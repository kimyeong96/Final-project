			...
			<div id="loginForm">
				...
				<div class="row socialRow justify-content-center align-items-center">
					<a class="social" id="kakaoBtn" target="_parent"><img
						...
						alt="오류가 발생했습니다."></a> <a class="social"
						href="${naverUrl}&auth_type=reauthenticate" target="_parent"><img
							...
							<div class="row find-box m-2 mt-4">
								...
								<div class="col-md-9 d-flex justify-content-center">
									<input type="text" id="find_phone" name="find_phone"
										class="form-control" placeholder="ex) 01012341234"
										maxlength="11">
								</div>
							</div>
					...
					<form id="findPwForm">
						<div id="findPw_body" class="modal-body">
							...
							<div class="row find-box mt-4">
								<div class="col-12 d-flex justify-content-center">
									<button type="button" class="btn" id="btnFindPW"
										style="background-color: #18365291; color: white;">
										비밀번호찾기</button>
								</div>
							</div>
						</div>
