...
<body>
	...
	<div class="row m-0 topHeader">
		<div class="row profileTitle mb-5 justify-content-center"
		...
		<div class="row justify-content-center">
			...
			<div class="col-8 profiles">
				<div class="col-12" id="profileName">
					<strong>${memberdto.user_nickname}</strong> <span
						style="font-size: 15px">님</span>
				</div>
				<div class="col-12 p-2" id="totalCount">
					<i class="fa-solid fa-file-pen"></i> <span> 전체 게시글 : </span> <span>${totalBoardCount}
						건</span>
				</div>
				<div class="col-12 p-2" id="boardCount">
					<i class="fa-solid fa-file-pen"></i> <span> 일반 게시글 : </span> <span>${selectBoardCount}
						건</span>
				</div>
				<div class="col-12 p-2" id="roomCount">
					<i class="fa-solid fa-file-pen"></i> <span> 모임 게시글 : </span> <span>${selectGroupBoardCount}
						건</span>
				</div>
			</div>
		</div>
	...
	<div id="Wrapper">
					...
					<form id="searchForm">
						<div class="row">
							<div class="col-12 mt-2"
								...
								<input class="d-none" type="text" id="user_email"
									value="${memberdto.user_email}"> <select
									...
									class="form-control keyword me-3" placeholder="검색"
									style="width: 250px;">
								<button type="button" class="btn btn-outline-secondary"
									id="searchBtn" style="width: 70px;">검색</button>
							</div>
						</div>
						<!-- breadcrumb -->
						<nav style="-bs-breadcrumb-divider: '&gt;';"
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item text-dark" aria-current="page">내가
									쓴 글</li>
							</ol>
						</nav>
					</form>
								...
								<tbody>
									<c:forEach items="${list}" var="selectBoardList">
										<tr>
											...
											<td><a
												href="/board/toDetailView?seq_board=${selectBoardList.seq_board}"
												style="color: black; text-decoration: none;">${selectBoardList.board_title}</a></td>
		...
		<div id="footWrapper" class="container">
			<div id="foot" class="row justify-content-end"
